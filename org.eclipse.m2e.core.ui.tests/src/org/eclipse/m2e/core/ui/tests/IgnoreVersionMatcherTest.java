...
public class IgnoreVersionMatcherTest {
	...
	private static IgnoreVersionMatcher getIgnoreVersionMatcher(String groupId, String artifactId, String xmlRuleSet)
		...
		RuleSet ruleSet = xmlRuleSet.isEmpty() ? new RuleSet() : RuleSetParser.fromXMLString(xmlRuleSet);
		RuleService ruleService = new RuleService(ruleSet);
		return new IgnoreVersionMatcher(ruleService.getIgnoredVersions(groupId, artifactId));
	}
}
